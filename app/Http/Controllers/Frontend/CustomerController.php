...
class CustomerController extends Controller
{
    ...
    //  Http::get('http://bulksmsbd.net/api/smsapi?api_key=D66rUdWdRJ7oNnAVdEO9&type=text&number='.$shipping->phone.'&senderid=8809617621720&message=আপনার অর্ডারটি প্লেস হয়েছে, শীগ্রই আমাদের প্রতিনিধি কল করে অর্ডারটি কনফার্ম করবেন। ORDER ID :'.$order->invoice_id.', Hotline:01838697860');
