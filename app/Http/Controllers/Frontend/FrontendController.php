...
class FrontendController extends Controller
{
    public function index()
    {
        ...
        return view('frontEnd.layouts.pages.index',
            compact('sliders', 'frontcategory', 'hotdeal_top', 'hotdeal_bottom', 'homeproducts', 'sliderbottomads',
                'footertopads'));
    }
    ...
    public function category($slug, Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.category',
            compact('category', 'products', 'subcategories', 'min_price', 'max_price'));
    }
    ...
    public function subcategory($slug, Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.subcategory',
            compact('subcategory', 'products', 'impproducts', 'childcategories', 'max_price', 'min_price'));
    }
    ...
    public function products($slug, Request $request)
    {
        ...
        return view('frontEnd.layouts.pages.childcategory',
            compact('childcategory', 'products', 'impproducts', 'min_price', 'max_price', 'childcategories'));
    }
    ...
    public function details($slug)
    {
        ...
        return view('frontEnd.layouts.pages.details',
            compact('details', 'products', 'shippingcharge', 'productcolors', 'productsizes', 'reviews'));
    }
    ...
    public function quickview(Request $request)
    {
        ...
        ])->with('images')->withCount('reviews')->first();
