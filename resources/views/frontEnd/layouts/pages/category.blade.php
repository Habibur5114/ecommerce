                            ...
                            <div class="accordion" id="category_sidebar">
                                <div class="accordion-item">
                                    <h2 class="accordion-header">
                                        <button class="accordion-button" style="background-color:#0f7bd5" type="button" data-bs-toggle="collapse"
                                ...
                                @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                    <div class="pro_btn">
                                        ...
                                        <form action="{{ route('cart.add-card') }}" method="POST">
                                            ...
                                            <button type="submit"   class="mb-2" style="background-color:#EBB8DD; color: black;">কার্টে যোগ করুন</button>
