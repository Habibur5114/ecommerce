                                    ...
                                    <div class="sale-badge">
                                        <div class="sale-badge-inner">
                                            <div class="sale-badge-box">
                                                <span class="sale-badge-text" style="background-color:#751b3a">
                                    ...
                                    <div class="product">
                                        <div class="product-cart">
                                            ...
                                            <div class="product-code">
                                                <p  style="background-color:#751b3a"><span>প্রোডাক্ট কোড : </span>{{ $details->product_code }}</p>
                                            </div>
                                            <form action="{{ route('cart.store') }}" method="POST" id="addcart" name="formName">
                                                ...
                                                @if ($productcolors->count() > 0)
                                                    <div class="pro-color" style="width: 100%;">
                                                                    ...
                                                                    @foreach ($productcolors as $procolor)
                                                                        <div class="selector-item">
                                                                            ...
                                                                            <label for="fc-option{{ $procolor->id }}"
                                                                                ...
                                                                                class="selector-item_label change_color_onNull">
                                                                                <span>
                                                        ...
                                                        <span class="color_error text-danger fw-bold"></span>
                                                    </div>
                                                    @endif @if ($productsizes->count() > 0)
                                                        ...
                                                        <div class="row">
                                                            <div class="qty-cart col-sm-12">
                                                              ...
                                                              <div class="d-flex single_product col-sm-12" style="column-gap: 10px">
                                                                @if ($productcolors->count() > 0)
                                                                <button style="background-color:#EBB8DD; color: black;" type="button" class="btn px-4 add_cart_btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Please Choose a Color!" onclick="changeButtonText(this)">
                                                                        কার্টে যোগ করুন
                                                                    </button>
                                                                <button type="button" class="btn px-4 add_cart_btn" data-bs-toggle="tooltip" data-bs-placement="top" title="Please Choose a Color!" onclick="changeButtonText(this)" style="background-color:  #4FB; color: black;">
                                                                        অর্ডার করুন
                                                                    </button>
                                                                @else
                                                                <input type="submit"style="background-color:#EBB8DD; color: black;" class="btn px-4 add_cart_btn"onclick="return sendSuccess();" name="add_cart"value="কার্টে যোগ করুন " />
                                                                <input type="submit"class="btn px-4 order_now_btn order_now_btn_m"onclick="return sendSuccess();" style="background-color:  #4FB; color: black;"name="order_now"value="অর্ডার করুন" />
                                                                @endif
                                                            </div>
                                                        </div>
                                                        <div class="mt-md-2 mt-2">
                                                            <h4 class="font-weight-bold">
                                                                <a class="btn btn-success w-100 call_now_btn" style="background-color: red";
                                    ...
                                    <div class="action">
                                        <div>
                                            <button type="button" class="details-action-btn question-btn btn-overlay"
                                                data-bs-toggle="modal" data-bs-target="#exampleModal" style="background-color:#751b3a">
                                                Write a review
                                            </button>
                                        </div>
                                    </div>
                            ...
                            @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                <div class="pro_btn">
                                    ...
                                    <form action="{{ route('cart.add-card') }}" method="POST">
                                       ...
                                       <button type="submit" class="mb-1" style="background-color:#EBB8DD; color: black;">কার্টে যোগ করুন</button>
                                        </form>

                                    <div class="cart_btn order_button">
                                        <a href="{{ route('product', $value->slug) }}"
                                            class="addcartbutton"  style="background-color:  #4FB; color: black;" >অর্ডার করুন</a>
                                    </div>
                                </div>
                            @else
                                <div class="pro_btn">
                                    ...
                                    <form action="{{ route('cart.store') }}" method="POST">
                                        ...
                                        <input type="hidden" name="id" value="{{ $value->id }}" />
                                        <input type="hidden" name="qty" value="1" />
                                        <button type="submit"  style="background-color:  #4FB; color: black;" >অর্ডার করুন</button>
                                    </form>
                                </div>
                            @endif
                        </div>
...
<script>
    ...
    $('input[type="radio"][name="product_color"]').click(function() {
        var selectedValue = $(this).val(); // Get the value of the clicked radio button
        if (selectedValue) {
            $('.single_product').html('<input type="submit" class="btn px-4 add_cart_btn"onclick="return sendSuccess();" style="background-color:#751b3a"; name="add_cart"value="কার্টে যোগ করুন " /><input type="submit"class="btn px-4 order_now_btn order_now_btn_m"onclick="return sendSuccess();" name="order_now"value="অর্ডার করুন" />');
            $('.change_color_onNull').css('border', '1px solid #ddd');
        }
        else{
            $('.single_product').html('Please Choose a Color!');
        }
    });
});
</script>
<script>
    const labels = document.querySelectorAll('.change_color_onNull');
    const color_error = document.querySelector('.color_error');
    console.log(color_error);

    function changeButtonText() {
        color_error.innerHTML = "Please Choose a Color!";
