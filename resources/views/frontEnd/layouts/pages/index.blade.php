...
<section class="homeproduct">
    <div class="container">
        <div class="row">
                            ...
                            @if (!$value->prosizes->isEmpty() || !$value->procolors->isEmpty())
                                <div class="pro_btn">
                                    <form action="{{ route('cart.add-card') }}" method="POST">
                                        ...
                                        <button type="submit" class="mb-1"  style="background-color:#EBB8DD; color: black;" >
                                            কার্টে যোগ করুন
                                        </button>
            ...
            <div class="col-sm-12">
               <a href="{{ route('hotdeals') }}" class="view_more_btn rounded"  >View More</a>
            </div>
        </div>
    </div>
</section>
    ...
    <section class="homeproduct">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-12">
                    <div class="show_more_btn mt-2">
                        <a href="{{ route('category', $homecat->slug) }}" class="view_more_btn rounded " >View More</a>
                    </div>
                </div>
            </div>
        </div>
