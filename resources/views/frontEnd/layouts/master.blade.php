...
<!-- End Google Tag Manager (noscript) -->
        ...
        <div class="mobile-menu">
                ...
                <ul class="first-nav">
                    ...
                    @endforeach
                        <li class="parent-category">
                            <a href="{{route('frontend.blog')}}" class="menu-category-name">
{{--                                <img src="" alt="" class="side_cat_img">--}}
                                <i class="fa fa-comment side_cat_img"></i>
                                BLOG
                            </a>
                                        ...
                                        <ul>
                                            ...
                                            <li class="cart-dialog" id="cart-qty">
                                                ...
                                                <div class="cshort-summary">
                                                    ...
                                                    <a href="{{route('customer.checkout')}}" class="go_cart"  style="background-color:#0f7bd5"> অর্ডার করুন  </a>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="col-sm-12">
                                <div class="catagory_menu" >
                                    <ul >
                                        ...
                                        @endforeach
                                        <li class="cat_bar"><a href="{{route('frontend.blog')}} " >Blog</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-4 mb-3 mb-sm-0">
                            <div class="footer-about">
                                ...
                                <a href="mailto:{{$contact->hotmail}}" class="footer-hotlint">{{$contact->hotmail}}</a>
                            </div>
                        </div>
                        <!-- col end -->
        ...
        <a href="{{App\Models\SocialMedia::first()->link}}" target="_blank" style="position: fixed;bottom: 150px;right: 18px;z-index:111">
            <img src="{{ asset('public/backEnd/assets/images') }}/messenger.png" style="height:60px;border-radius:50%">
        </a>

        <a href="https://wa.me/+88{{App\Models\Contact::first()->phone}}?text=I%20am%20interested" target="_blank" style="position: fixed;bottom: 70px;right: 13px;z-index:111">
            <img src="https://img.icons8.com/color/48/000000/whatsapp.png" style="height:70px;border-radius:50%">
        </a>
