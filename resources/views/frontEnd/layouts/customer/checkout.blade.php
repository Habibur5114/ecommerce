            ...
            <div class="col-sm-5 cus-order-2">
                <div class="checkout-shipping">
                    <form action="{{ route('customer.ordersave') }}" method="POST" data-parsley-validate="">
                        @csrf
                        <div class="card response3">
                           <div class="card-header">
                                <h6>আপনার অর্ডারটি কনফার্ম করতে তথ্যগুলো পূরণ করে <span style="color:#fe5200;">"অর্ডার করুন"</span></h6>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="name">আপনার নাম লিখুন <span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="phone">আপনার নাম্বার লিখুন <span style="color:red">*</span></label>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="address">ঠিকানা লিখুন <span style="color:red">*</span> জেলা,উপজেলা,থানা,পৌরসভা</label>
                                     ...
                                     <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="text">মন্তব্য লিখুন (অপশনাল)</label>
                                            <input type="text"
                                                class="form-control"
                                                name=""
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group mb-3">
                                            <label for="area">ডেলিভারি এরিয়া নিবার্চন করুন <span style="color:red">*</span></label>
                                            <div>
                                                @foreach ($shippingcharge as $key => $value)
                                                    <div class="form-check">
                                                        <input type="radio" id="area-{{ $value->id }}" name="area" value="{{ $value->id }}"
                                                               class="form-check-input @error('area') is-invalid @enderror" required>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <button class="order_place" type="submit" style="background-color:#0f7bd5">অর্ডার করুন</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
