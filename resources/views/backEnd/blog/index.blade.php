                        ...
                        <table id="datatable-buttons" class="table table-striped dt-responsive nowrap w-100">
                            ...
                            @foreach($blogs as $key=>$value)
                                <tr>
                                    ...
                                    <td><img src="{{asset($value->blog_image)}}" class="backend-image" alt=""></td>
                                    ...
                                    <td>
                                        <div class="button-list">
                                            @if($value->status == 1)
                                                <form method="post" action="{{route('blogs.inactive')}}"
                                                      class="d-inline">
                                                    @csrf
                                            ...
                                            @endif
                                                ...
                                                <a href="{{route('comments.list',$value->id)}}"
                                                   class="btn btn-xs btn-success waves-effect waves-light"><i
                                                            class="fe-package"></i></a>
                                            ...
                                            <form method="post" action="{{route('comments.destroy',$value->id)}}" class="d-inline">
                                                @csrf
                                                @method('DELETE')
{{--                                                <input type="hidden" value="{{$value->id}}" name="hidden_id">--}}
                                                <button type="submit"
